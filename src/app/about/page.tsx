        ...
        <div className="">
            ...
            <div className="sm:p-0 md:3 p-3 grid md:grid-cols-12 grid-cols-1">
                <div className="sm:col-span-4 ">
                    <Image src={Profile} className=" sm:w-[400px] hidden sm:block w-[300px] sm:ml-[80px] mx-auto" alt="" />
                </div>
                <div className="sm:mt-[30px] mt-[20px] sm:col-span-8 sm:w-[700px] w-full mx-auto">
